                ...
                <div class="relative">
                    ...
                    <div class="relative -mt-16 p-4">
                        ...
                        <div class="bg-white dark:bg-gray-700 text-white w-full h-24 rounded-xl p-4 flex justify-between items-center">
                            <div class="p-2">
                                <h1 class="text-xl text-red-700 dark:text-white font-semibold">Menu</h1>
                                <span class="text-center mt-4 text-sm text-gray-700 dark:text-white">List all menu</span>
                            </div>
                            <div class="p-2">
                                <a href="{{route('food.create')}}" class="bg-red-500 text-white px-6 py-2 rounded-md hover:bg-red-700">Create New</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td>
                                    <form action="{{route('food.destroy', $item->id)}}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="{{route('food.show', $item->id )}}" class="text-red-600 font-semibold p-2">Detail</a>
